...
The key distinction is not whether a weapon contains software; it is whether perception, tracking, or engagement-adjacent judgment shifts from a human-operated tool to an autonomous or semi-autonomous system whose errors, escalation pathways, and accountability chain must be governed.
